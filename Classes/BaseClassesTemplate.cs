...
public class BusinessLogicLayerTemplate_5G_CSHARP : ITemplate
{
    ...
    private void BuildDataHandlerBaseNET40(string nameSpace)
    {
        ...
        output.AppendLine("    /// <summary>");
        output.AppendLine("    /// Returns if trannsaction is opened");
        output.AppendLine("    /// </summary>");
        output.AppendLine("    public bool IsTransactionOpened()");
        output.AppendLine("    {");
        ...
        output.AppendLine("    /// <returns></returns>");
        output.AppendLine("    /// <remarks></remarks>");
        output.AppendLine("    internal virtual IDbTransaction BeginTransaction(System.Data.IsolationLevel isolationLevel = IsolationLevel.Unspecified)");
        output.AppendLine("    {");
        output.AppendLine("        try");
        output.AppendLine("        {");
        ...
        output.AppendLine("            {");
        output.AppendLine("                throw (new Exception(Constants.ERROR_CONNECTION_NOT_OPENED_YET));");
        output.AppendLine("            }");
        output.AppendLine("            else");
        output.AppendLine("            if (_transaction == null)");
        output.AppendLine("            {");
    ...
    private void BuildDataHandler()
    {
        ...
        output.AppendLine("    internal virtual IDbTransaction BeginTransaction(System.Data.IsolationLevel isolationLevel = IsolationLevel.Unspecified)");
        output.AppendLine("    {");
        output.AppendLine("        return  base.BeginTransaction(isolationLevel);");
        output.AppendLine("    }");
        output.AppendLine("    /// <summary>");
        output.AppendLine("    /// Ends a Transaction with commit  or rollback passed as boolean.");
        output.AppendLine("    /// </summary>");
        ...
        output.AppendLine("    {");
        output.AppendLine("        return base.EndTransaction(commit);");
        output.AppendLine("    }");
        output.AppendLine("}");
    ...
    private void BuildConstants(GenerationProject generationProject)
    {
        ...
        output.AppendLine("         internal const string ERROR_CONNECTION_NOT_OPENED_YET = " + System.Convert.ToChar(34) + "Connection not opened yet" + System.Convert.ToChar(34) + ";");
